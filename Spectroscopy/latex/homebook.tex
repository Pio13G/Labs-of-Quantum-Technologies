...
\bigskip
\centerline{\Huge\bfseries\sf Lab of Quantum Technologies}
\vspace{2cm}
...
%
\centerline{\Large Authors: Group 6}
\vspace{2cm}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AUTHORS
...
%
\centerline{Di Padova,Filip,Garrone,Maurutto,Propedo}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{2cm}
\centerline{\today}
...
%%
\input{./AtomicSpettroscopy/AtomicSpettroscopy.tex}
%%
